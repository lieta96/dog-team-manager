...
export default function Navbar() {
  return (
    <nav className="flex justify-between items-center p-4 w-full ">
      <Link href="/" className="text-2xl font-bold hover:text-button transition-all duration-300">
        Dog Team Manager
      </Link>
      <Link
        href="/my-team"
      ...
      >
        <div className="w-6 h-6">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" alt="" className="fill-primary group-hover:fill-button transition-all duration-300">
        ...
        <span className="group-hover:text-button transition-all duration-300">My Team</span>
      </Link>
    </nav>
  );
}
